...
byte device_id = 0xAEF872;

byte temperature[8] = {0x00, 0, 0, 0, 0, 0, 0, 0};
byte meter[8] = {0, 0, 0, 0, 0, 0, 0};
...
void ReadtoPinConfig() {
  if (Serial.available() > 0) {
    ...
    if (MAX_VALUES > 6) control_bin = values[6];
  }
}
...
void loop() {
  ...
  Serial.print(send_powermeter());
  //Serial.print(int(temperature));
  
  //Serial.println("0112#4567#8#456#222#222#222#222#222");
...
String send_temperature() {
  ...
  String(dlc_data) = "8";
  return String(device_id) + "#" + String(data_id_temp) + "#" + String(dlc_data) + "#" + String(adc_val0) + "#" + String(adc_val1) 
  + String(adc_val2) + "#" +"#" + String(digi_val0);
}

String send_powermeter() {
  String(data_id_volt) = "1221";
  String(dlc_data) = "8";
  return String(device_id) + "#" + String(data_id_volt) +"#" + String(dlc_data) + "#"
  + String(adc_val3) + "#" + String(adc_val4) + "#" + String(adc_val5)  
  + "#" + String(digi_val1) + "#" + String(digi_val2);
}
